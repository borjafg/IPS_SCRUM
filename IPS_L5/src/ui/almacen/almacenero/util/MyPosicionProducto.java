...
public class MyPosicionProducto implements Comparable<MyPosicionProducto> {
	...
	public int compareTo(MyPosicionProducto arg0) {
		...
		if (posProducto.getPasillo() < arg0.posProducto.getPasillo())
			...
			if( posProducto.getEstanteriaPoducto().equals(EstanteriaProducto.IZQUIERDA) && arg0.getPosicionProducto().getEstanteriaPoducto().equals(EstanteriaProducto.DERECHA))
				return -1;
			else if (posProducto.getEstanteriaPoducto().equals(EstanteriaProducto.DERECHA) && arg0.getPosicionProducto().getEstanteriaPoducto().equals(EstanteriaProducto.IZQUIERDA))
				return 1;
			else {
	...
	public String toString() {
		return "Pasillo: " + posProducto.getPasillo() + " - Estantería: " + posProducto.getEstanteriaPoducto() + " - Posición x: " + posProducto.getPosicionX()
			+ " - Altura: " + posProducto.getAltura();
	}
